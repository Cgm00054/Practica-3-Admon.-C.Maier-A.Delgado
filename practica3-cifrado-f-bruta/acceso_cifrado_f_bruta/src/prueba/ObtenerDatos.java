...
/**
 * La clase ObtenerDatos implementa cuatro m茅todos p煤blicos que permiten obtener
...
public class ObtenerDatos {
    ...
    // m閠odo para recoger el nombre del DNIe:
    ...
    public String leerDeCertificadoNom(CardChannel ch) throws CardException {
        ...
        if ((byte) r.getSW() == (byte) 0x9000) {
            ...
            if (datos[offset] == 0x30) {
                offset += datos[offset + 1] + 2; //Obviamos la seccion de la informacion sobre la fecha de expedici贸n etc
            }

            if ((byte) datos[offset] == (byte) 0xA1) {
                //El certificado empieza aqu铆
                byte[] r3 = new byte[9];
    ...
    /**
     * Este m茅todo establece la conexi贸n con la tarjeta. La funci贸n busca el
     * Terminal que contenga una tarjeta, independientemente del tipo de tarjeta
     * que sea.
     *
     * @return objeto Card con conexi贸n establecida
     * @throws Exception
     */
    ...
    /**
     * Este m茅todo nos permite saber el tipo de tarjeta que estamos leyendo del
     * Terminal, a partir del ATR de 茅sta.
     *
